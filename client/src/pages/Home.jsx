    ...
    <>
      ...
      <header className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto mt-16">
          {/* ── Badge ── */}
          <span className="inline-block py-1 px-3 rounded-full bg-white/10 backdrop-blur border border-white/20 text-white text-xs sm:text-sm font-medium tracking-wider mb-6 uppercase whitespace-normal break-words max-w-xs mx-auto">
