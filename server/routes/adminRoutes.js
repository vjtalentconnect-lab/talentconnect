...
import { adminVerifySchema, updateUserRoleSchema, updateProjectStatusSchema } from '../lib/schemas.js';
...
router.put('/projects/:id/status', validate(updateProjectStatusSchema), updateProjectStatus);
